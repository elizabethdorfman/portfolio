...
export default function Blog() {
  ...
  useEffect(() => {
    ...
    description?.setAttribute('content', post?.summary ?? 'Writing about software, AI, and designing simple and intuitive technology.');
    ...
    for (const [key, value] of Object.entries({ 'og:title': post?.title ?? "Elizabeth's Software Engineering Blog", 'og:description': post?.summary ?? 'Writing about software, AI, and designing simple and intuitive technology.', 'og:url': url, 'og:type': post ? 'article' : 'website', 'og:image': 'https://elizabethdorfman.com/write-like-a-human-preview.png', 'twitter:title': post?.title ?? "Elizabeth's Software Engineering Blog", 'twitter:description': post?.summary ?? 'Writing about software, AI, and designing simple and intuitive technology.', 'twitter:image': 'https://elizabethdorfman.com/write-like-a-human-preview.png' })) {
